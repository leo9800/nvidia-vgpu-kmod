...
package_nvidia-vgpu-18-kmod-hardened() {
	pkgdesc="NVIDIA vGPU kernel modules v18 for linux-hardened"
	depends=('linux-hardened' "nvidia-vgpu-18-utils=${pkgver}")
...
package_nvidia-vgpu-18-kmod-hardened-open() {
	pkgdesc="NVIDIA vGPU kernel modules v18 for linux-hardened, open source"
	depends=('linux-hardened' "nvidia-vgpu-18-utils=${pkgver}")
