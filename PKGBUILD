...
package_nvidia-vgpu-16-kmod() {
	pkgdesc="NVIDIA vGPU kernel modules v16"
	depends=('linux' "nvidia-vgpu-16-utils=${pkgver}")
...
package_nvidia-vgpu-16-kmod-unlock() {
	pkgdesc="NVIDIA vGPU kernel modules v16, with vGPU unlock patch"
	depends=('linux' "nvidia-vgpu-16-utils-unlock=${pkgver}")
	provides=('NVIDIA-MODULE' 'nvidia')
	conflicts=('NVIDIA-MODULE' 'nvidia')
